...
## Why to Build a REST API with GO?![REST API with GO](https://raw.githubusercontent.com/gin-gonic/logo/master/color.png)
...
## What’s GIN? ![REST API with GIN Framework](https://raw.githubusercontent.com/gin-gonic/logo/master/color.png)
